...
- Blink detection: MediaPipe landmark eyelid collapse (159-145 left, 386-374 right), close<0.015, open>0.022, timing 80-700ms, 200ms face-drop tolerance during CLOSED state
...
- Blink detection: MediaPipe landmark eyelid collapse (159-145 left, 386-374 right), close<0.015, open>0.022, time-validated (80-700ms), 60ms polling, 1200ms warmup
